...
const headInnerContent = ()=>{
    ...
    header.innerHTML = `
    <div class="flex_box px-5  align-items-center">
        <a href="index.html">
...
function selectContactText() {
    const textElement = document.getElementById('tell');
...
const tellBtn = document.querySelector('.btn-primary')
...
document.addEventListener("DOMContentLoaded",()=>{
    ...
    tellBtn.addEventListener('click',selectContactText)

            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 pc_font_size_head">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="current.html">입주기업현황</a>
                        </li>
                        <li>
                            <a href="graduate.html">졸업기업현황</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
    ...
    <div class="container px-5">
        <div class="row align-items-center justify-content-between flex-column flex-sm-row inner_box">
            ...
            <div class="col-auto footer_logos">
                ...
                <a class="link-light small mr-3" href="https://www.instagram.com/hanseo.m.startup/" target="_blank">
                ...
                <a class="link-light small mr-3" href="https://blog.naver.com/hanseomstartup" target="_blank">
                ...
                <a class="link-light small" href="https://cafe.naver.com/hanseomstartup" target="_blank">
